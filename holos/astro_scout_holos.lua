...
body = {
    ...
    rightarm = {
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-16,-295,4),Angle(80,90,0),"models/props_combine/breenlight.mdl",Vector(2.8,2.8,1.6),false,Color(255,40,40,255),"models/props_combine/metal_combinebridge001","RightArmBone3")),
