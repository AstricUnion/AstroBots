...
body = {
    base = {
        hologram.createPart(
            Holo(SubHolo(Vector(0,0,-5.75),Angle(90,45,0),"models/xqm/deg360single.mdl",Vector(0.5,3.5,3.5),true,Color(255,0,0,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(-85,0,-10),Angle(0,180,0),"models/props_combine/combine_barricade_med02c.mdl",Vector(0.5,0.5,0.35),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(-60,-70,-10),Angle(0,-150,0),"models/props_combine/combine_barricade_tall03a.mdl",Vector(0.25,0.5,0.15),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(-60,70,-10),Angle(0,150,0),"models/props_combine/combine_barricade_tall04a.mdl",Vector(0.25,0.5,0.15),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(100,0,-10),Angle(0,0,0),"models/props_combine/combine_barricade_med02a.mdl",Vector(0.4,0.4,0.3),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(90,35,-12),Angle(0,25,0),"models/props_combine/combine_barricade_tall01b.mdl",Vector(0.25,0.35,0.15),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(90,-35,-12),Angle(0,-25,0),"models/props_combine/combine_barricade_tall01b.mdl",Vector(0.25,0.35,0.15),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(75,55,-10),Angle(0,45,0),"models/props_combine/combine_barricade_tall01b.mdl",Vector(0.25,0.35,0.125),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(75,-55,-10),Angle(0,-45,0),"models/props_combine/combine_barricade_tall01b.mdl",Vector(0.25,0.35,0.125),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(45,80,-10),Angle(0,65,0),"models/props_combine/combine_barricade_tall01b.mdl",Vector(0.25,0.35,0.1),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(45,-80,-10),Angle(0,-65,0),"models/props_combine/combine_barricade_tall01b.mdl",Vector(0.25,0.35,0.1),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(0,115,15),Angle(-45,-90,180),"models/props_combine/combine_barricade_med02a.mdl",Vector(0.3,0.35,0.35),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(0,-115,15),Angle(-45,90,180),"models/props_combine/combine_barricade_med02a.mdl",Vector(0.3,0.35,0.35),false,Color(255,0,0,255),"")),
            Holo(SubHolo(Vector(15,0,-35),Angle(45,0,180),"models/props_combine/combineinnerwallcluster1024_003a.mdl",Vector(0.10,0.16,0.10),false,Color(255,40,40,255),"")),
            Holo(SubHolo(Vector(-15,0,-35),Angle(45,180,180),"models/props_combine/combineinnerwallcluster1024_003a.mdl",Vector(0.10,0.16,0.10),false,Color(255,40,40,255),""))
        ),
        hologram.createPart(
            Holo(Rig(Vector(0,0,0))),
            Holo(SubHolo(Vector(0,0,-21),Angle(0,0,0),"models/props_phx/wheels/moped_tire.mdl",Vector(4.5,4.5,4.5),false,Color(255,0,0,255),"models/props_combine/metal_combinebridge001")),
            Holo(SubHolo(Vector(0,0,0),Angle(90,0,0),"models/props_c17/pulleywheels_large01.mdl",Vector(1.5,4.5,4.5),false,Color(255,0,0,255),"models/props_combine/metal_combinebridge001")),
            Holo(SubHolo(Vector(0,0,-35),Angle(0,0,0),"models/props_phx/wheels/moped_tire.mdl",Vector(2,2,5),false,Color(255,0,0,255),"models/props_combine/metal_combinebridge001")),
            Holo(SubHolo(Vector(0,0,-20),Angle(90,0,0),"models/props_c17/pulleywheels_large01.mdl",Vector(2.5,2.5,2.5),false,Color(255,0,0,255),"models/props_combine/metal_combinebridge001"))
        ),
    },
    head = {
        hologram.createPart(
    ...
    leftarm = {
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(0,170,-12),Angle(0,90,0),"models/props_combine/CombineTrain01a.mdl",Vector(0.175,0.4,0.15),false,Color(255,0,0,255),"")),
    ...
    rightarm = {
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-3,-270,-0),Angle(-90,0,0),"models/props_phx/wheels/trucktire.mdl",Vector(0.5,0.5,1.25),false,Color(200,0,0,255),"")),
            Holo(SubHolo(Vector(3,-270,-0),Angle(90,0,0),"models/props_phx/wheels/trucktire.mdl",Vector(0.5,0.5,1.25),false,Color(200,0,0,255),"")),
            Holo(SubHolo(Vector(-1.25,-270,-0),Angle(90,0,0),"models/Items/combine_rifle_ammo01.mdl",Vector(4.0,4.0,2.25),false,Color(200,0,0,255),"")),
            Holo(SubHolo(Vector(-1.25,-270,-0),Angle(0,90,90),"models/Items/combine_rifle_ammo01.mdl",Vector(4.0,4.0,2.25),false,Color(200,0,0,255),"")),
            Holo(SubHolo(Vector(1.25,-270,-0),Angle(-90,0,0),"models/Items/combine_rifle_ammo01.mdl",Vector(4.0,4.0,2.25),false,Color(200,0,0,255),"")),
            Holo(SubHolo(Vector(1.25,-270,-0),Angle(0,90,-90),"models/Items/combine_rifle_ammo01.mdl",Vector(4.0,4.0,2.25),false,Color(200,0,0,255),"")),
            ...
            Holo(SubHolo(Vector(0,-340,-4),Angle(93,-90,0),"models/props_combine/combineinnerwallcluster1024_001a.mdl",Vector(0.075,0.01,0.15),true,Color(255,0,0,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,-325,13),Angle(-93,-90,180),"models/props_combine/combineinnerwallcluster1024_001a.mdl",Vector(0.05,0.01,0.15),true,Color(255,0,0,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,-340,-4),Angle(93,-90,0),"models/props_combine/combineinnerwallcluster1024_001a.mdl",Vector(0.075,0.01,0.15),true,Color(255,255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(0,-325,13),Angle(-93,-90,180),"models/props_combine/combineinnerwallcluster1024_001a.mdl",Vector(0.05,0.01,0.15),true,Color(255,255,255,255),"models/wireframe"))
